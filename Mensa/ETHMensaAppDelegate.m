...
@implementation ETHMensaAppDelegate

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    self.window = [[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
    self.window.rootViewController = [ETHMensaRootViewController new];
...
//    [[[GAI sharedInstance] logger] setLogLevel:kGAILogLevelVerbose];
    [[GAI sharedInstance] trackerWithTrackingId:@"UA-56051114-1"];
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ETHMensaLoadMenus" object:application];
}
